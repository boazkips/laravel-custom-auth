...
<head>
    ...
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="{{ asset('theme/e.png') }}">
    <!-- Page Title  -->
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                <div class="brand-logo pb-5">
                                    <a href="{{ route('login') }}" class="logo-link">
                                        <img class="logo-light logo-img logo-img-lg" src="{{ asset('theme/b.png') }}" srcset="{{ asset('theme/b.png') }}" alt="logo">
                                        <img class="logo-dark logo-img logo-img-lg" src="{{ asset('theme/b.png') }}" srcset="{{ asset('theme/b.png') }}" alt="logo-dark">
                                    </a>
                                </div>
                                ...
                                <div class="form-note-s2 pt-4"> New on our platform? <a href="{{ route('register') }}">Request Demo here</a>
                                </div>
                                <div class="text-center pt-4 pb-3">
                                    <h6 class="overline-title overline-title-sap"><span>OR</span></h6>
                                </div>
                                <ul class="nav justify-center gx-4">
                                    <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/askaritechnologies ">Facebook</a></li>
                                    <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/company/askari-technologies/">LinkedIn</a></li>
                                </ul>
